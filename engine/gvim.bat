...
start /MAX "" /D "." %gvim_path%                                                                                                                                                      	                                    ^
     ...
     -c ":nnoremap <F6> :!<CR>"                                                                                                                                                                                             ^
     -c ":autocmd VimEnter * if filereadable(expand(\"%session_path%\")) | :source %session_path% | :source %vimrc_path% | else | :args **\*.h **\*.cpp **\*.inl **\*.txt | :b todo.txt | :source %vimrc_path% | endif"     ^
