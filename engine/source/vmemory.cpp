...
void Virtual_Arena::create(size_t bytesize){
...
#else
    static_assert(false, "Virtual_Arena::create() not implemented for this platform");
#endif
}
...
#else
    static_assert(false, "Virtual_Arena::destroy() not implemented for this platform");
#endif
