namespace GL{
    ...
    Program_Binary retrieve_program_cache(Program handle){
        ...
        cache.memory = (char*)malloc(sizeof(char) * (size_t)binary_length);
    ...
    bool check_error_shader(const GLuint shader, const char* const message){
        ...
        if(shader_status != GL_TRUE){
            ...
            char* shader_log = (char*)malloc(sizeof(char) * (size_t)shader_log_length);
            ...
            char* shader_source = (char*)malloc(sizeof(char) * (size_t)shader_source_length);
    ...
    bool check_error_program(const GLuint program, const char* const message){
        ...
        if(linking_status != GL_TRUE){
            ...
            char* program_log = (char*)malloc(sizeof(char) * (size_t)program_log_length);
    ...
    bool check_debug_message_log(){
        ...
        char* debug_message_log = (char*)malloc(sizeof(char) * (size_t)max_debug_message_length);
    ...
    char* get_object_label(GLenum type, GLuint handle){
        ...
        char* label = (char*)malloc(sizeof(char) * (size_t)max_label_length);
