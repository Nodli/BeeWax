namespace BEEWAX_INTERNAL{
    ...
    xoroshiro128plus_state xoroshiro128plus_seed = { ((u64)rand()) << 32u || ((u64)rand()), ((u64)rand()) << 32u || ((u64)rand())};
    ...
    static u64 xoroshiro128plus_step(xoroshiro128plus_state& seed = BEEWAX_INTERNAL::xoroshiro128plus_seed){
    ...
    static xoroshiro128plus_state xoroshiro128plus_offset_small(xoroshiro128plus_state& seed = BEEWAX_INTERNAL::xoroshiro128plus_seed){
    ...
    static xoroshiro128plus_state xoroshiro128plus_offset_large(xoroshiro128plus_state& seed = BEEWAX_INTERNAL::xoroshiro128plus_seed){
        xoroshiro128plus_state output = {0u, 0u};
...
u32* random_permutation(u32 permutation_size, BEEWAX_INTERNAL::xoroshiro128plus_state& seed){
    ...
    u32* output = (u32*)bw_malloc((size_t)permutation_size * sizeof(u32));
