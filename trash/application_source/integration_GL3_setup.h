static const char* vertex_shader_glitchy_tex = vertex_shader_polygon_2D_tex;
static const char* fragment_shader_glitchy_tex = R"(
    ...
    void main(){
        ...
        if(effect_index == 0){
            ...
            output_color = vec4(0., sample_color.b, sample_color.g, sample_color.a);
        }else if(effect_index == 2){
            output_color = vec4(sample_color.r, 0., sample_color.b, sample_color.a);
        }else if(effect_index == 3){
            output_color = vec4(sample_color.r, sample_color.g, 0., sample_color.a);
        }
    }
)";
