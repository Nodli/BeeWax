...
namespace utest{
    ...
    void t_array(){
        ...
        array.reserve(4);
        success &= (array.size == 2 && array.capacity == 4 && array[0] == 1 && array[1] == 2);

        array.insert(1, 3);
        success &= (array.size == 3 && array.capacity == 4 && array[0] == 1 && array[1] == 3 && array[2] == 2);

        array.reserve(8);
        success &= (array.size == 3 && array.capacity == 8);
        ...
        array.push(13);
        array.push(14);
        success &= (array.size == 13 && array.capacity == 32 && array[0] == 4 && array[1] == 7);

        array.clear();
        success &= (array.size == 0 && array.capacity == 32);
    ...
    void t_dhashmap(){
        ...
        {
            s32* search;
            bool search_success = hmap.search(1, search);
            success &= search_success;
        }

        {
            s32* get;
            bool get_creation = hmap.get(1, get);
            success &= (get != nullptr && get_creation);
            *get = -1;

            s32* search;
            bool search_success = hmap.search(1);
            success &= (search_success && search == get && *search == -1);
...
#undef t_constexpr_sqrt_unit
    ...
    void run(){
        ...
        utest::t_Virtual_Arena();

        utest::t_array();
        utest::t_pool();
        utest::t_dhashmap();
        utest::t_dhashmap_randomized();
        ...
        utest::t_isort();
        utest::t_binsearch();
        utest::t_constexpr_sqrt();
        utest::t_Dense_Grid();

        utest::t_coord_conversion();
        utest::t_triangulation_2D();
        ...
        //utest::t_detect_vector_capacilities();
        //utest::t_find_noise_magic_normalizer();
        //utest::t_compare_triangulation_2D();
